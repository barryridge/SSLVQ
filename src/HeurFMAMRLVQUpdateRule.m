classdef HeurFMAMRLVQUpdateRule < UpdateRule
    ...
    methods (Static = true)
        ...
        function Mod = update(Algo, Mod, Data, iData, varargin)
            ...
            % for bmu...
            b_h_to_l1 = Mod.AuxDists(1);

            % The risk of deciding in favour of the 'class'
            % for bmu2...
            b_h_to_l2 = Mod.AuxDists(2);
            ...
            if ~xor((b_h_to_l1 < Mod.AuxDistStats.mean()), (b_h_to_l2 < Mod.AuxDistStats.mean())) || outside_window
                % If the closest BMU is of the correct 'class'...
                if b_h_to_l1 < Mod.AuxDistStats.mean()
