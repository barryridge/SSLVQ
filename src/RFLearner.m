classdef RFLearner < Learner
    % RFLEARNER Summary of this class goes here
    ...
    methods
        ...
        %******************************************************************
        %******************************************************************
        function obj = RFLearner(varargin)
...
%             end
        ...
        function obj = train(obj, varargin)
            ...
            while i <= length(varargin), 
                ...
                if ~argok, 
                    disp(['RFLearner.train(): Ignoring invalid argument #' num2str(i)]);
                    fprintf(obj.UsageMessage);
                end
