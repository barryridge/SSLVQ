classdef GRLVQLearner < Learner
    % GRLVQLEARNER Summary of this class goes here
    ...
    methods
        ...
        %******************************************************************
        %******************************************************************
        function obj = GRLVQLearner(varargin)
...
%             end
        ...
        function obj = train(obj, varargin)
            ...
            while i <= length(varargin), 
                ...
                if ~argok, 
                    disp(['GRLVQLearner.train(): Ignoring invalid argument #' num2str(i)]);
                    fprintf(obj.UsageMessage);
                end
            ...
            [obj.yproto_est_GRLVQ, obj.Wproto_est_GRLVQ, obj.lambda_est_GRLVQ,  obj.E_GRLVQ] =...
                grlvq_model(Xtrain, ytrain, obj.Options, obj.yproto_ini, obj.Wproto_ini, obj.lambda_ini);            
            
            obj.FeatureMask = obj.lambda_est_GRLVQ;
        ...
        function [TestData Mask] = classify(obj, varargin)        
            ...
            ytest_est_GRLVQ = NN_predict(Xtest, obj.yproto_est_GRLVQ, obj.Wproto_est_GRLVQ, obj.lambda_est_GRLVQ , obj.Options);
            
            TestData.Results.InToOutClassification = ytest_est_GRLVQ;
