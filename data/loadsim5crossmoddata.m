...
% 
%
function Data = loadsim5crossmoddata(varargin)
    ...
    Mod1XClass1 = rand2DGaussian([0.4 0.5],[0.01 0;0 0.01],sample_size/2)';    
    Mod1XClass2 = rand2DGaussian([0.6 0.5],[0.01 0;0 0.01],sample_size/2)';
    Mod2XClass1 = rand2DGaussian([0.5 0.25],[0.01 0;0 0.005],sample_size/2)';
    Mod2XClass2 = rand2DGaussian([0.5 0.75],[0.01 0;0 0.005],sample_size/2)';
