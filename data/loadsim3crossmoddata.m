...
% 
%
function Data = loadsim3crossmoddata(varargin)
    ...
    Mod1XClass1 = rand2DGaussian([0.33 0.5],[0.005 0;0 0.01],sample_size/2)';    
    Mod1XClass2 = rand2DGaussian([0.66 0.5],[0.005 0;0 0.01],sample_size/2)';
    Mod2XClass1 = rand2DGaussian([0.5 0.33],[0.01 0;0 0.005],sample_size/2)';
    Mod2XClass2 = rand2DGaussian([0.5 0.66],[0.01 0;0 0.005],sample_size/2)';
    YClass1 = ones(sample_size/2,1);
    YClass2 = 2 * ones(sample_size/2,1);
            
    %% Build the Data struct...
    X = [Mod1XClass1' Mod1XClass2'; Mod2XClass1' Mod2XClass2']';
    Y = [YClass1' YClass2']';        
