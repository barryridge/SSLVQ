...
% 
%
function Data = loadexample1crossmoddata(varargin)
    ...
    Foo = rand2DGaussian([0.25 0.5],[0.0005 0;0 0.01],500)';
    Foo(:,3) = 1;
    Bar = rand2DGaussian([0.75 0.5],[0.0005 0;0 0.01],500)';
    Bar(:,3) = 2;
    Foo = [Foo' Bar']';
    % Foo = gencluster([0.25 0.5], [0.1, 1], [1, 1], [0, 0], 500, 1);
    % Foo = [Foo' gencluster([0.75 0.5], [0.1, 1], [1, 1], [0, 0], 500, 2)']';
